package com.quantum.integrator.handler;
...
public class MOEHandlerTableShaped extends ShapedRecipeHandler {
	public List<IRecipe> recipeList;
	public Class<? extends GuiContainer> guiClass;
	public String recipeName;

	public MOEHandlerTableShaped(List<IRecipe> recipes, Class<? extends GuiContainer> gui, String name) {
		recipeList = recipes;
		guiClass = gui;
		recipeName = name;
	}
	...
	public TemplateRecipeHandler newInstance() {
		return new MOEHandlerTableShaped(recipeList, guiClass, recipeName);
	}
